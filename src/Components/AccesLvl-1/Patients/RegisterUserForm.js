...
import { addPatientDetails, modifyAddressPD, changeCurrent, addNotes, modifyIllness, addTreatmentID, addDrugsToTH, createHT, getNursesNames, getDoctorsNames, modifyMedicalStaff } from '../../utils/UserFunctions'
...
class RegisterForm extends React.Component {
    ...
    handleNext = () => {
        ...
        if (currentStep === 2) {
            ...
            // CREATE FUNCTION TO STEP THE CURRENT TREATMENT TO FALSE
