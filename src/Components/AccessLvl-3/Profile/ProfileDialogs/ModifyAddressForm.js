...
import { modifyAddressPD} from '../../../utils/UserFunctions'
...
class ModifyAddressForm extends React.Component {
    state = {
        country: '',
        city: '',
        street: '',
    ...
    constructor(props) {
        ...
        this.state.curUserDetailsID = this.props.curUserDetailsID;
    }
    ...
    onSubmit = (e) => {
        const address = {
            ...
            patientDetailsID: this.state.curUserDetailsID,
        }
        modifyAddressPD(address);
...
ModifyAddressForm.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withRouter(withStyles(styles)(ModifyAddressForm));